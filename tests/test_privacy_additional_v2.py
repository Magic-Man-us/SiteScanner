"""Additional tests for Privacy and Compliance scanner checks (v2)."""
...
@pytest.mark.asyncio
async def test_missing_hsts_and_frame_protection_v2(mock_session):
...
@pytest.mark.asyncio
async def test_gdpr_pci_heuristics_detects_missing_privacy_and_card_input_v2(mock_session):
